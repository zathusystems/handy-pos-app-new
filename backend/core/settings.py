...
DEFAULT_ALLOWED_HOSTS = [
    ...
    'pos2.express-travel-ticketing.online',
    'api.handypos.online',
    'menu.handypos.online',
...
DEFAULT_CSRF_TRUSTED_ORIGINS = [
    ...
    'https://api.handypos.online',
    'https://menu.handypos.online',
    'https://app.handypos.online',
]
...
# Public HTTPS origin used when third-party payment providers need callback URLs
# that can reach this backend from outside the device.
PAYMENT_PUBLIC_BASE_URL = os.getenv('PAYMENT_PUBLIC_BASE_URL', '').strip()
PUBLIC_MENU_BASE_URL = os.getenv('PUBLIC_MENU_BASE_URL', '').strip().rstrip('/')

# Disable APPEND_SLASH to prevent redirect issues with POST requests
APPEND_SLASH = False

# Respect Nginx proxy headers for HTTPS termination on a VPS.

...
class InventoryItem(models.Model):
    ...
    reserved_stock_units = models.DecimalField(
        max_digits=12,
        decimal_places=3,
    ...
    @property
    def available_stock_units(self):
        """Stock available for new sales after laybuy reservations."""
        stock = self.stock_units or Decimal('0')
        reserved = self.reserved_stock_units or Decimal('0')
        return max(Decimal('0'), stock - reserved)
    ...
    def get_available_portions(self):
        ...
        if self.is_sold_in_portions and self.portions_per_unit and self.portions_per_unit > 0:
            return int(self.available_stock_units * self.portions_per_unit)
        return None

...
VALID_STOCK_STATUSES = {'In Stock', 'Low Stock', 'Out of Stock'}
...
def handle_create_inventory_item(item_id, data, business, branch_id):
    ...
    try:
        ...
        portion_price_raw = data.get('portion_price')
        if portion_price_raw is None:
            portion_price_raw = data.get('portionPrice')
...
def handle_update_inventory_item(item_id, data, business, branch_id):
    ...
    try:
        ...
        if 'portion_price' in data or 'portionPrice' in data:
            portion_price_value = data.get('portion_price') if 'portion_price' in data else data.get('portionPrice')
            item.portion_price = _parse_finite_float(portion_price_value, 'portion_price', None)

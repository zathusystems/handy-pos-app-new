...
const mapBackendOrderToLocal = (
  ...
  return {
    ...
    deposit_amount: toNumber(order?.deposit_amount ?? order?.depositAmount ?? order?.laybuy_deposit ?? order?.laybuyDeposit),
    laybuyPaymentMethod: toOptionalString(order?.laybuy_payment_method ?? order?.laybuyPaymentMethod),
    laybuy_payment_method: toOptionalString(order?.laybuy_payment_method ?? order?.laybuyPaymentMethod),
    ...
    buyerAuthorizationCode: toOptionalString(order?.buyer_authorization_code ?? order?.buyerAuthorizationCode),
    buyer_authorization_code: toOptionalString(order?.buyer_authorization_code ?? order?.buyerAuthorizationCode),
    isExport: Boolean(order?.is_export ?? order?.isExport ?? false),
    is_export: Boolean(order?.is_export ?? order?.isExport ?? false),
    isReliefSupply: Boolean(order?.is_relief_supply ?? order?.isReliefSupply ?? false),
    is_relief_supply: Boolean(order?.is_relief_supply ?? order?.isReliefSupply ?? false),
    vat5ProjectNumber: toOptionalString(order?.vat5_project_number ?? order?.vat5ProjectNumber),
    vat5_project_number: toOptionalString(order?.vat5_project_number ?? order?.vat5ProjectNumber),
    vat5CertificateNumber: toOptionalString(order?.vat5_certificate_number ?? order?.vat5CertificateNumber),
    vat5_certificate_number: toOptionalString(order?.vat5_certificate_number ?? order?.vat5CertificateNumber),
    vat5Quantity: toNumber(order?.vat5_quantity ?? order?.vat5Quantity),
    vat5_quantity: toNumber(order?.vat5_quantity ?? order?.vat5Quantity),
    eisValidationMetadata: order?.eis_validation_metadata ?? order?.eisValidationMetadata ?? {},
    eis_validation_metadata: order?.eis_validation_metadata ?? order?.eisValidationMetadata ?? {},

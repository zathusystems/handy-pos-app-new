...
const sheetVariants = cva(
  "fixed z-50 box-border max-h-[100dvh] gap-4 bg-background p-6 shadow-lg transition ease-in-out tauri-android-safe-bottom data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
